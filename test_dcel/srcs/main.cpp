...
void test1() {
	...
	//dcel->add_bbox(pt_2d(-1.0, -1.0), pt_2d(7.0, 7.0));
	//dcel->add_bbox(pt_2d(-1.0, -1.0), pt_2d(2.0, 2.0));
	//dcel->add_bbox(pt_2d(0.1, -1.0), pt_2d(2.0, 2.0));
