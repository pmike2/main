...
StaticObj::StaticObj(glm::vec2 pt_min, glm::vec2 pt_max) {
	_aabb= new AABB_2D(pt_min, pt_max);
}
...
AnimObj::AnimObj(glm::vec2 pt_min, glm::vec2 pt_max) : _velocity(glm::vec2(0.0f)) {
	_aabb= new AABB_2D(pt_min, pt_max);
}
