...
ViewSystem::ViewSystem(ScreenGL * screengl) :
	_screengl(screengl),
...
void ViewSystem::update_selection_norms() {
	number xmin = std::min(_rect_select->_gl_origin.x, _rect_select->_gl_moving.x);
	number ymin = std::min(_rect_select->_gl_origin.y, _rect_select->_gl_moving.y);
	number xmax = std::max(_rect_select->_gl_origin.x, _rect_select->_gl_moving.x);
	number ymax = std::max(_rect_select->_gl_origin.y, _rect_select->_gl_moving.y);
