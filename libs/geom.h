...
struct Pt {
	...
	pt_type_3d _coords; // coordonnées
...
struct Face {
	...
	pt_type_3d _normal; // vecteur normal à la face
...
public:
	...
	Pt * add_pt(pt_type_3d coords); // ajout pt
	...
	void randomize(uint n_pts, pt_type_3d vmin, pt_type_3d vmax);
	void compute(); // calcul
