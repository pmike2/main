...
Font::Font(GLuint prog_draw, string font_path, unsigned int font_size, unsigned int screen_width, unsigned int screen_height) :
	_prog_draw(prog_draw), _alpha(1.0f) 
{
