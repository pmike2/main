...
void main(void) {
	...
	vertex_color = (1.0 - step(0.3, fow)) * vec4(0.5, 0.5, 0.5, 1.0)
		+ step(0.3, fow) * (1.0 - step(0.7, fow)) * mix(vertex_color, vec4(0.5, 0.5, 0.5, 1.0), 0.7)
		+ step(0.7, fow) * vertex_color;
	
	vertex_normal = (1.0 - step(0.3, fow)) * vec3(0.0, 0.0, 1.0) + step(0.3, fow) * vertex_normal;
