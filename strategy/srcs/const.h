...
const number OVERVIEW_TEXTURE_SIZE = 1024;
...
enum PLAY_MODE {SELECT_UNIT, ADD_UNIT, ACTION_UNIT, ADD_BARRIER};
enum EDIT_MODE {ADD_ELEMENT, EDIT_ELEVATION, ERASE};
enum UNIT_ACTION_MODE {WAIT, WATCH, MOVE, ATTACK, DESTROY};

enum UNIT_STATUS {UNIT_WATCHING, UNIT_ATTACKING, UNIT_SHOOTING, UNIT_DESTROYED, UNIT_UNDER_CONSTRUCTION, UNIT_INACTIVE};
