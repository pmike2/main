...
layout(location=3) in vec3 tex_coord_in;
layout(location=4) in float idx_action;
layout(location=5) in float idx_frame;
layout(location=6) in mat4 model2world_matrix;
