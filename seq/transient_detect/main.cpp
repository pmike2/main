...
int main(int argc, char* argv[]) {
	...
	boost::filesystem::path file_path_in(path_in);
	if (!boost::filesystem::exists(file_path_in)) {
	...
	// -------------------------------------------------------------------------
	boost::filesystem::path file_path_rms= file_path_in.parent_path() / file_path_in.stem();
	string path_rms= file_path_rms.string()+ "_rms.wav";
	...
	// -------------------------------------------------------------------------
	boost::filesystem::path file_path_exp_decay= file_path_in.parent_path() / file_path_in.stem();
	string path_exp_decay= file_path_exp_decay.string()+ "_exp_decay.wav";
	...
	// -------------------------------------------------------------------------
	boost::filesystem::path file_path_markers= file_path_in.parent_path() / file_path_in.stem();
	string path_markers= file_path_markers.string()+ "_markers.wav";
