...
void test() {
	unsigned int n_ligs= 5;
	unsigned int n_cols= 5;
	glm::vec2 origin(0.0f, 0.0f);
	glm::vec2 size(10.0f, 10.0f);
	unsigned int start= rand_int(0, 20);
	unsigned int goal= rand_int(0, 20);
	...
	cout << "searching\n";
	vector<unsigned int> path= pf->path_find_nodes(start, goal);
	cout << "drawing\n";
