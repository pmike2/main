...
app.get('/polygons_test', (req, res) => {
	res.sendFile(path.resolve(__dirname, 'tests', 'polygons_test.html'));
});

app.get('/timeline_test', (req, res) => {
	res.sendFile(path.resolve(__dirname, 'tests', 'timeline_test.html'));
});

app.get('/affine_transfo_test', (req, res) => {
	res.sendFile(path.resolve(__dirname, 'tests', 'affine_transfo_test.html'));
});
